...
if menu_id == "Home":
    ...
    with cc[4]:
        hc.info_card(title='Intervention Sectors', title_text_size="2rem", content_text_size="1.4rem", content=sectors_value, theme_override=theme_5)

    cc1 = st.columns(3)
    with cc1[0]:
        hc.info_card(title='Most Wanted Jobs', title_text_size="2rem", content_text_size="1.4rem", content=item, theme_override=theme_6)

    with cc1[1]:
        hc.info_card(title='Top Hiring Organizations', title_text_size="2rem", content_text_size="1.4rem", content=item2, theme_override=theme_7)

    with cc1[2]:
        hc.info_card(title='Top Majors Requested', title_text_size="2rem", content_text_size="1.4rem", content=item3, theme_override=theme_8)
    ...
    with cc2[3]:
        hc.info_card(title='Intermediate or experienced',title_text_size="2rem", content_text_size="1.4rem", content=f'{per_top_lev}%', theme_override=theme_12)

    with cc2[4]:
        hc.info_card(title='Bachelor Degree',title_text_size="2rem", content_text_size="1.4rem", content=f'{per_top_bac}%', theme_override=theme_13)
